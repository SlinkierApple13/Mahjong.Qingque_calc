...
#define KNITTED_STRAIGHT_DEFAULT true
    ...
    public:
        ...
        hand(const hand& h) : win_type(h.win_type), win_tile(h.win_tile), open_melds(h.open_melds), closed_counter(h.closed_counter), total_counter(h.total_counter), knitted_straight_allowed(h.knitted_straight_allowed) {
