...
namespace qingque {
    ...
    const std::vector<fan> fans = {
        ...
        fan("七对", {1, 1, 0, 22, 0}, criteria::seven_pairs),
        ...
        fan("字一色", {1, 0, 0, 23, 0}, criteria::all_honours),
        fan("大四喜", {23u}, criteria::big_four_winds),
        fan("小四喜", {22u}, criteria::little_four_winds),
        fan("四喜对", {1, 1, 0, 21, 0}, criteria::four_wind_pairs),
        fan("大三元", {22u}, criteria::big_three_dragons),
        fan("小三元", {22u}, criteria::little_three_dragons),
        fan("三元六对", {1, 1, 0, 23, 0}, criteria::six_dragon_pairs),
        ...
        fan("二般高", {21u}, criteria::two_double_sequences),
